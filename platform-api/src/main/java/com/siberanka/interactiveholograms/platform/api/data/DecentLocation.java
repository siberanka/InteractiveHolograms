...
package com.siberanka.interactiveholograms.platform.api.data;
...
public final class DecentLocation {
     ...
     */
    @Contract(pure = true)
    public DecentLocation(@NotNull String worldName, double x, double y, double z, float yaw, float pitch) {
