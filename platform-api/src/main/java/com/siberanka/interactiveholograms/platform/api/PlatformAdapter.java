...
package com.siberanka.interactiveholograms.platform.api;
...
/**
 * Represents an adapter that bridges platform-specific functionality with the InteractiveHolograms core.
 *
 * @author d0by
 * @since 2.10.0
 */
