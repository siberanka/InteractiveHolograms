...
import com.siberanka.interactiveholograms.profiler.Timer;

import java.util.Collections;

@CommandInfo(
        usage = "/ih profiler reset [timer]",
...
class ProfilerResetCommand extends DecentCommand {
    ...
    ProfilerResetCommand(DecentProfiler profiler) {
        super("reset");
    ...
    public CommandHandler getCommandHandler() {
        return (sender, args) -> {
            ...
            profiler.reset();
            Lang.PROFILER_RESET.send(sender);
            return true;
        };
    }
