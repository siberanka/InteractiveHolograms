...
package com.siberanka.interactiveholograms;

/**
 * Permissions of InteractiveHolograms.
 */
public final class Permissions {
    ...
    public static final String ADMIN = "ih.admin";
    public static final String DEFAULT = "ih.default";

    // -- Commands

    private static final String COMMANDS = "ih.command";
