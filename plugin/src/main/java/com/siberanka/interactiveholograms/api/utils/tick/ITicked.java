package com.siberanka.interactiveholograms.api.utils.tick;
 ...
 * can be registered to InteractiveHologramsAPI ticker. This ticker will call the tick() method every
...
public interface ITicked {
    ...
    default void register() {
        InteractiveHologramsAPI.get().getTicker().register(this);
    }
    ...
    default void unregister() {
        InteractiveHologramsAPI.get().getTicker().unregister(getId());
    }
