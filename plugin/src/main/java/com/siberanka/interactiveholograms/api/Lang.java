...
public class Lang {
    ...
    public static final Phrase NEW_VERSION_AVAILABLE = new Phrase("new_version_available", "&fA newer version of &3InteractiveHolograms &fis available. Download it from:");
    ...
    public static void reload() {
        FileConfig config = new FileConfig(INTERACTIVE_HOLOGRAMS.getPlugin(), "lang.yml");
