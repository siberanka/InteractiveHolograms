...
import com.siberanka.interactiveholograms.api.utils.config.CFG;
import com.siberanka.interactiveholograms.api.utils.config.FileConfig;
import com.siberanka.interactiveholograms.api.utils.config.Key;
...
public class Settings {
    ...
    public static void reload() {
        config = new FileConfig(INTERACTIVE_HOLOGRAMS.getPlugin(), "config.yml");

        CFG.load(INTERACTIVE_HOLOGRAMS.getPlugin(), Settings.class, config.getFile());
