...
import com.siberanka.interactiveholograms.api.utils.reflect.ReflectField;
import com.siberanka.interactiveholograms.api.utils.reflect.ReflectMethod;
import com.siberanka.interactiveholograms.api.utils.reflect.ReflectionUtil;
...
public class CommandManager {
    ...
    public static void register(Command command) {
        ...
        SimpleCommandMap commandMap = GET_COMMAND_MAP_METHOD.invoke(InteractiveHologramsAPI.get().getPlugin().getServer());
        CommandManager.unregister(command);
        commandMap.register("InteractiveHolograms", command);
    }
