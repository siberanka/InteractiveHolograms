...
import com.siberanka.interactiveholograms.profiler.command.ProfilerCommand;
...
@CommandInfo(
		aliases = {"ih", "holograms", "hologram", "holo", "dh"},
		permissions = {Permissions.DEFAULT, Permissions.COMMAND_INTERACTIVE_HOLOGRAMS},
		usage = "/ih <args>",
		description = "The main InteractiveHolograms command."
)
public class HologramsCommand extends DecentCommand {
    ...
    @CommandInfo(
            ...
            usage = "/ih version",
            aliases = {"ver", "about"},
            description = "Shows some info about your current InteractiveHolograms version."
    )
    ...
    public static class ListSubCommand extends DecentCommand {
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                Message.sendPaginatedMessage((Player) sender, currentPage, "/ih list %d", 15, header, null, holograms, parseItem);
                return true;
            };
        }
