...
public class HologramSubCommand extends DecentCommand {
    ...
    @CommandInfo(
            ...
            usage = "/ih hologram update <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram align <hologram> <X|Y|Z|XZ|FACE> <otherHologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram center <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram clone <hologram> <name> [temp] [-l:<world:x:y:z>]",
	...
	@CommandInfo(
			...
			usage = "/ih hologram create <name> [-l:world:x:y:z] [--center] [content]",
	...
	@CommandInfo(
			...
			usage = "/ih hologram delete <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram disable <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram setdisplayrange <hologram> <range>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram downorigin <hologram> <true|false>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram enable <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram setfacing <hologram> <facing>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram addflag <hologram> <flag>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram removeflag <hologram> <flag>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram info <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram lines <hologram> <page> [listPage]",
			...
			return (sender, args) -> {
				...
				for (int i = startIndex; i < endIndex; i++) {
					...
					if (Validator.isPlayer(sender)) {
						String suggest = String.format("/ih l set %s %s %s", args[0], i + 1, line.getContent());
				...
				if (maxPage > 0) {
					((Player) sender).spigot().sendMessage(Message.getPagesComponents(currentPage,
							maxPage == currentPage, "/ih h lines " + args[0] + " " + pageIndex + " %d")
					);
					sender.sendMessage("");
				}
				return true;
	...
	@CommandInfo(
			...
			usage = "/ih hologram movehere <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram move <hologram> <x> <y> <z>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram setpermission <hologram> [permission]",
	...
	@CommandInfo(
			...
			usage = "/ih hologram teleport <hologram>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram setupdateinterval <hologram> <interval>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram setupdaterange <hologram> <range>",
	...
	@CommandInfo(
			...
			usage = "/ih hologram rename <hologram> <new_name>",
