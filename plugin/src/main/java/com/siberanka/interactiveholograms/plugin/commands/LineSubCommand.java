package com.siberanka.interactiveholograms.plugin.commands;
...
import com.siberanka.interactiveholograms.api.commands.CommandBase;
...
import com.siberanka.interactiveholograms.api.utils.entity.DecentEntityType;
...
@CommandInfo(
		permissions = {Permissions.COMMAND_LINES},
		usage = "/ih lines help",
...
public class LineSubCommand extends DecentCommand {
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_ADD},
			usage = "/ih line add <hologram> <page> [content]",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_ALIGN},
			usage = "/ih line align <hologram> <page> <line1> <line2> <X|Z|XZ|FACE>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_EDIT},
			usage = "/ih line edit <hologram> <page> <line>",
	...
	static class LineEditSub extends DecentCommand {
		...
		public CommandHandler getCommandHandler() {
			return (sender, args) -> {
				...
				String suggest = String.format("/ih l set %s %s %s %s", args[0], args[1], args[2], line.getContent());
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_ADD_FLAG},
			usage = "/ih line addflag <hologram> <page> <line> <flag>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_REMOVE_FLAG},
			usage = "/ih line removeflag <hologram> <page> <line> <flag>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_HEIGHT},
			usage = "/ih line height <hologram> <page> <line> <height>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_HELP},
			usage = "/ih line help",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_INFO},
			usage = "/ih line info <hologram> <page> <line>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_INSERT},
			usage = "/ih line insert <hologram> <page> <line> [content]",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_OFFSET_X},
			usage = "/ih line offsetX <hologram> <page> <line> <offset>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_OFFSET_Z},
			usage = "/ih line offsetZ <hologram> <page> <line> <offset>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_SET_PERMISSION},
			usage = "/ih line setpermission <hologram> <page> <line> [permission]",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_REMOVE},
			usage = "/ih line remove <hologram> <page> <line>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_SET},
			usage = "/ih line set <hologram> <page> <line> <content>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_SWAP},
			usage = "/ih line swap <hologram> <page> <line1> <line2>",
	...
	@CommandInfo(
			permissions = {Permissions.COMMAND_LINES_FACING},
			usage = "/ih line setfacing <hologram> <page> <line> <facing>",
	...
	// Utility method to handle all "/ih <subcommand> <hologram> <page> <line>" stuff
