...
public class PageSubCommand extends DecentCommand {
    ...
    @CommandInfo(
            ...
            usage = "/ih page add <hologram> [content]",
    ...
    @CommandInfo(
            ...
            usage = "/ih page insert <hologram> <page> [content]",
    ...
    @CommandInfo(
            ...
            usage = "/ih page remove <hologram> <page>",
    ...
    @CommandInfo(
            ...
            usage = "/ih page swap <hologram> <page1> <page2>",
    ...
    @CommandInfo(
            ...
            usage = "/ih page switch <hologram> <page> [player]",
    ...
    @CommandInfo(
            ...
            usage = "/ih page actions <hologram> <page> <clickType> [listPage]",
    ...
    static class PageActionsSub extends DecentCommand {
        ...
        public CommandHandler getCommandHandler() {
            return (sender, args) -> {
                ...
                String commandFormat = "/ih actions " + args[0] + " " + args[1] + " " + args[2] + " %d";
    ...
    @CommandInfo(
            ...
            usage = "/ih page clearactions <hologram> <page> <clickType>",
    ...
    @CommandInfo(
            ...
            usage = "/ih page addaction <hologram> <page> <clickType> <action>",
    ...
    @CommandInfo(
            ...
            usage = "/ih page removeaction <hologram> <page> <clickType> <index>",
