...
package com.siberanka.interactiveholograms.integration;
...
public enum Integration {
    ...
    public boolean isAvailable() {
        IntegrationAvailabilityService integrationAvailabilityService = InteractiveHologramsAPI.get().getIntegrationAvailabilityService();
