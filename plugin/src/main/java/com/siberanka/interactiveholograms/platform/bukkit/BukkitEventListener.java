...
public class BukkitEventListener implements PlatformEventListener {

    private final BukkitRenderService renderService;

    public BukkitEventListener(BukkitRenderService renderService) {
        this.renderService = renderService;
    }

    @Override
    public void onDisplayDestroyed(@NotNull String name) {
        renderService.unloadDisplay(name);
    }
}
