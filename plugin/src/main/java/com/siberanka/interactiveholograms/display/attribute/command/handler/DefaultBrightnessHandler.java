...
import com.siberanka.interactiveholograms.display.attribute.value.display.BrightnessValue;
...
public class DefaultBrightnessHandler implements AttributeCommandHandler<DisplayBrightness> {
