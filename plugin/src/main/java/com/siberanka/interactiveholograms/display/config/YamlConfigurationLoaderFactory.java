    ...
    public YamlConfigurationLoader createLoader(Path path) {
        return YamlConfigurationLoader.builder()
                ...
                .defaultOptions(options ->
                        options.header("InteractiveHolograms packet hologram configuration. See WIKI.md for every option.")
                                .serializers(serializerCollection -> serializerCollection.registerAll(typeSerializerCollection))
                )
                .build();
    }
}
