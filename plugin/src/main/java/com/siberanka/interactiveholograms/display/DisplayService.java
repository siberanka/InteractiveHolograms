...
import com.siberanka.interactiveholograms.display.config.DisplayConfigException;
...
public class DisplayService {
    ...
    public void saveDisplay(DisplayBase display) {
        registerDisplay(display);
        if (display.getSettings().isPersistent()) {
            persistenceService.saveDisplay(display);
        } else {
            persistenceService.deleteDisplay(display);
        }
    }
