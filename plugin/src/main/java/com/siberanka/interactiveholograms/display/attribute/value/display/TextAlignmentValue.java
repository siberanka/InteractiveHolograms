...
package com.siberanka.interactiveholograms.display.attribute.value.display;
...
public final class TextAlignmentValue implements AttributeValue<TextDisplayAlignment> {

    private final TextDisplayAlignment alignment;

    public TextAlignmentValue(TextDisplayAlignment alignment) {
        this.alignment = alignment;
    }

    @Override
    public String getTypeKey() {
        return TextAlignmentValueType.TYPE_ID;
    }

    @Override
    public CompiledAttributeValue<TextDisplayAlignment> compile(DisplayRenderContext context) {
        return new StaticCompiledAttributeValue<>(alignment);
    }
