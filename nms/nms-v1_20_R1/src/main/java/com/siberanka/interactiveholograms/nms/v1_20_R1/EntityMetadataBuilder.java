...
class EntityMetadataBuilder {
    ...
    EntityMetadataBuilder withBlockDisplayBlockData(Material material) {
        Block block = BuiltInRegistries.f.a(MinecraftKey.a("minecraft:" + material.name().toLowerCase(), ':'));

        watchableObjects.add(EntityMetadataType.BLOCK_DISPLAY_BLOCK_PROPERTIES.construct(block.n()));
        return this;
    }
}
