package com.siberanka.interactiveholograms.nms.v1_12_R1;
...
class InboundPacketHandler extends ChannelInboundHandlerAdapter {
    ...
    private NmsEntityInteractAction extractEntityInteractAction(PacketPlayInUseEntity useEntityPacket) {
        ...
        PacketPlayInUseEntity.EnumEntityUseAction enumEntityUseAction = useEntityPacket.a();
        switch (enumEntityUseAction) {
            ...
            case INTERACT_AT:
                ...
                break;
            default:
                throw new InteractiveHologramsNmsException("Unknown entity use action: " + enumEntityUseAction.name());
        }
        return action;
    }
