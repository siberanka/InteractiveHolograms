...
class PacketDataSerializerWrapper {
    ...
    void writeToPacket(Packet<?> packet) {
        try {
            ...
            throw new InteractiveHologramsNmsException("Failed to write data to packet", e);
        }
    }
    ...
    void writeWatchableObjects(List<DataWatcher.Item<?>> watchableObjects) {
        try {
            ...
            throw new InteractiveHologramsNmsException("Failed to write watchable objects", e);
        }
    }
