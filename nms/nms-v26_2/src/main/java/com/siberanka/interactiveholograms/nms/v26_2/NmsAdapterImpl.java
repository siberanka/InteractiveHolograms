...
public class NmsAdapterImpl implements NmsAdapter {
    ...
    private ChannelPipeline getPipeline(Player player) {
        ...
        Connection networkManager = CONNECTION_FIELD.get(playerConnection);
    ...
    private void throwFailedToModifyPipelineException(Player player, Exception e) {
        throw new InteractiveHologramsNmsException("Failed to modify player's pipeline. player: " + player.getName(), e);
    }
}
